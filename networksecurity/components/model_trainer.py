...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, classificationmetric):
        ...
        # Log the model as an artifact – this works fine on DagsHub
            mlflow.sklearn.log_model(best_model, name=best_model.__class__.__name__)
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            raise CustomException(f"error accured in initiate_model_trainer: {str(e)}",sys)